function IdleTrillionairePrivacyPolicy() {
  const style = {
    color: "white",
  };
  ...
  return (
    <div style={{ ...style, height: "100%", padding: "20px" }}>
      ...
      <p style={style}>
        We may use third-party services that may collect information from you.
        Please review their respective privacy policies for more information on
...
export default IdleTrillionairePrivacyPolicy;
